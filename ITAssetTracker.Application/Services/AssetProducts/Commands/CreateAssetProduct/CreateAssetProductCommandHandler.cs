...
public class CreateAssetProductCommandHandler : IRequestHandler<CreateAssetProductCommand, int>
{
    ...
    public async Task<int> Handle(CreateAssetProductCommand request, CancellationToken cancellationToken)
    {
