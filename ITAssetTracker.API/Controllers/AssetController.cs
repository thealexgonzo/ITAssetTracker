...
namespace ITAssetTracker.API.Controllers;
...
public class AssetController : Controller
{
    ...
    public async Task<ActionResult<AssetDetailsViewModel>> GetAssetById(int id)
    {
        ...
        AssetDetailsViewModel dto = await mediator.Send(getAssetDetailsQuery);
        return Ok(dto);
    }
    ...
    {
        List<AssetListViewModel> dtos = await mediator.Send(new GetAssetsListQuery());
        return Ok(dtos);
    }
